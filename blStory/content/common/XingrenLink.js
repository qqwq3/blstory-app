...
class XingrenLink extends React.Component {
    static propTypes = {
    ...
    render() {
        return (
            ...
            >
                <Text
                    style={[styles.descTextStyle, this.props.textStyle, this.props.disabled ? this.props.disabledTextStyle : null]}
                >
                    {this.props.text}
                </Text>
            </TouchableOpacity>
